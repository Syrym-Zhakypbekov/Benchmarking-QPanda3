...
IoT sensor data used in this study is available in the repository (\path{1.exl.csv}) or can be generated synthetically using the provided data generation script (\path{src/data/iot_sensor_data.py}) for full reproducibility. All experiments use fixed random seeds (\texttt{random\_state=42}) to ensure reproducibility.

For detailed methodology and step-by-step reproduction instructions, see the repository documentation (\path{docs/METHODOLOGY.md}).
...
Origin Quantum, ``QPanda3 Documentation,'' 2024. [Online]. Available: \url{https://qpanda-tutorial.readthedocs.io/}
